...
namespace NL.Text {
    ...
    public static class Transform {
        ...
        private static Dictionary<TextType, TextConverter> Converters = new() {
            ...
            { TextType.FullWidth, new(BaseAlphabetNumbersAndSymbols, "ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚ１２３４５６７８９０．／－＝[]；＇，．<>？：|{}！＠＃＄％^＆＊（）_＋－＝") },
            { TextType.UpsideDown, new(BaseAlphabetNumbersAndSymbols.Invert(), "=-+‾()*⅋^%$#@¡{}|:¿<>.ʻ╻;[]=-/.068𝘓95ߤ↋↊⇂Z⅄XϺɅՈꓕSꓤꝹԀONꟽ⅂ꓘᒋIH⅁ᖵƎᗡϽꓭ∀zʎxʍʌnʇsɹbdouɯʅʞɾᴉɥƃⅎǝpɔqɐ") },
